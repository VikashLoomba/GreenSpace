    ...
    <body>      
        <div class="container">
            <div class="row">
                ...
                <h1 class="text-center">Product: <?= $search_results['name']?></h1>
            </div>
            <div class="row" id="top-half">
                <!-- the left column contains the strain rating and icon/images -->
                <div class ="col-md-6 pull-left">
                    <div class="center">
                        <img class="center-block" id="stars" src="<?=$search_results['star_image']?>">
                        ...
                        <div class="display_inline">
                            <ul class="thumbs .col-md-offset-2">
                                <li><img class="bud-thumb" src="<?=$search_results['thumb_img1']?>"></li>
                                <li><img class="bud-thumb" src="<?=$search_results['thumb_img2']?>"></li>
                                <li><img class="bud-thumb" src="<?=$search_results['thumb_img3']?>"></li>
                                <li><img class="bud-thumb" src="<?=$search_results['thumb_img4']?>"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <!-- right column contains the strain attribute visual -->
                <div class="col-md-6 pull-right" id="effects_div">
                    <h3>Effects</h3>
                    <ul class="skill-bar">
                        <li>
                            <p>Openness to novel experience:</p>
                            <div class="wrapper"><span id="open" data-width="<?=$search_results['effects1']?>"></span></div>
                        </li>
                        <li>
                            <p>Happy:</p>
                            <div class="wrapper"><span id="happy" data-width="<?=$search_results['effects2']?>"></span></div>
                        </li>
                        <li>
                            <p>Relaxed:</p>
                            <div class="wrapper"><span id="relaxed" data-width="<?=$search_results['effects3']?>"></span></div>
                        </li>
                        <li>
                            <p>Uplifted:</p>
                            <div class="wrapper"><span id="uplifted" data-width="<?=$search_results['effects4']?>"></span></div>
                        </li>
                        <li>
                            <p>Creativity:</p>
                            <div class="wrapper"><span id="creativity" data-width="<?=$search_results['effects5']?>"></span></div>
                        </li>
                    </ul>
                </div>   
            </div>
            <div class="row">
                <?php if($search_results['test_graph']){?>
                <div class="col-md-6 pull-left small">
                    <?=$search_results['description']?>
                </div>
                <div class="col-md-6 pull-right">
                    <img id="test-graph" src="<?=$search_results['test_graph']?>">
                </div>
                <?php }?>

                <?php if(!$search_results['test_graph']){?>
                <div class="col-md-6 pull-right small">
                    <?=$search_results['description']?>
                </div>
                <?php }?>
            </div>
        <!-- LOAD VENDOR INFO DIV USING PARTIALS -->
            <div class="row">
                <div class="col-md-3" id="vendor_div"></div>   
            </div>
    </div>
