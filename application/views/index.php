...
<body>
    ...
    <div class="mobilenav">
        <ul>
            <li>
                <span class="nav-label"><a class='login' href='/mains/user_login'>User Login</a></span>
            </li>
            <li>
                <span class="nav-label"><a class='login' href='/vendors'>Vendor Login</a></span>
            </li>
            <li>
                <span class="nav-label"><a class='login' href='/mains/user_registration'>User Registration</a></span>
            </li>
            <li>
                <span class="nav-label"><a class='login' href='/vendor/register'>Vendor Registration</a></span>
            </li>
