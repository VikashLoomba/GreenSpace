	...
	<div class='container margin-top-large'>
				...
				<div class='row margin-bottom-large'>
                    ...
                    <div class='col-md-9'>
                        ...
                        <div class='row related'>
                            <img class='rating' src="<?= $strain['starImage']; ?>">
                        </div>
                    </div>
				</div>
		<?php } ?>
        <div class='row text-center'>
            <ul class='list-inline'>
                <?php
                    $page_url = '/search/1' . $this->session->flashdata('search') . '/1';
                ?>
                <li><a href="/search/1"><div class='page active_page'></a></li>
                <?php for ($i = 1; $i < $total / 5; $i++) { 
                    $num = 2;
                    $page_url = '/search/' . $num ?>
                    <li><a href="<?= $page_url ?>"><div class='page'></div></a></li>
                <?php $num++; } ?>
            </ul>
        </div>
	</div>
