...
--
-- Table structure for table `products_belong_to_order`
--

DROP TABLE IF EXISTS `products_belong_to_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `products_belong_to_order` (
...
--
-- Dumping data for table `products_belong_to_order`
--

LOCK TABLES `products_belong_to_order` WRITE;
/*!40000 ALTER TABLE `products_belong_to_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `products_belong_to_order` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-07-23 12:04:12
