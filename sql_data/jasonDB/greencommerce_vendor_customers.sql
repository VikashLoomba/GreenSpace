...
CREATE TABLE `vendor_customers` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_vendor_customers_users1_idx` (`user_id`),
  KEY `fk_vendor_customers_vendors1_idx` (`vendor_id`),
  CONSTRAINT `fk_vendor_customers_users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_vendor_customers_vendors1` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
